...
class ParlourLocationEdit extends StatefulWidget {
  const ParlourLocationEdit({Key key}) : super(key: key);

  @override
  _ParlourLocationEditState createState() => _ParlourLocationEditState();
}

class _ParlourLocationEditState extends State<ParlourLocationEdit> {
