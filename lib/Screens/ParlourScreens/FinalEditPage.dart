                              ...
                              builder: (BuildContext context) => AlertDialog(
                                ...
                                actions: <Widget>[
                                  ...
                                  TextButton(
                                      ...
                                      style: agree? ButtonStyle(backgroundColor: MaterialStateProperty.all(Colors.blue)) : ButtonStyle(backgroundColor: MaterialStateProperty.all(Colors.grey)),
                                      child: Text('Accept', style: agree? TextStyle(color: Colors.white) : TextStyle(color: Colors.white10),)
                                  ),
                                ],
                              ),
                          ),
